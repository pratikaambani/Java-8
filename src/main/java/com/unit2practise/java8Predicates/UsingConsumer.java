...
public class UsingConsumer {
    public static void main(String args[]) {
        ...
        performConditionally(people, p -> p.getfName().startsWith("p"), p -> System.out.println(p));


        System.out.println("Firstname of People having firstname starting with P");
        performConditionally(people, p -> p.getfName().startsWith("p"), p -> System.out.println(p.getfName()));
    }
